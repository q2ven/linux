 ...
 * Creates a new socket and assigns it to @res, passing through LSM.
 *
 * The socket holds a reference count of the network namespace that
 * the caller process belongs to.  The number of sockets is available
 * in the first line of /proc/net/sockstat.
 *
 * Context: Process context. This function internally uses GFP_KERNEL.
