...
static const struct snmp_mib snmp4_net_list[] = {
	...
	SNMP_MIB_ITEM("TCPEDOSuccess", LINUX_MIB_TCPEDOSUCCESS),
	SNMP_MIB_ITEM("TCPEDOFallbackSYN", LINUX_MIB_TCPEDOFALLBACKSYN),
	SNMP_MIB_ITEM("TCPEDOFallbackSYNACK", LINUX_MIB_TCPEDOFALLBACKSYNACK),
	SNMP_MIB_ITEM("TCPEDOFallbackACK", LINUX_MIB_TCPEDOFALLBACKACK),
	SNMP_MIB_SENTINEL
};
