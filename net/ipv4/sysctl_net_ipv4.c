...
static struct ctl_table ipv4_net_table[] = {
	...
	{
		.procname	= "tcp_ext_data_offset",
		.data		= &init_net.ipv4.sysctl_tcp_ext_data_offset,
		.maxlen		= sizeof(u8),
		.mode		= 0644,
		.proc_handler	= proc_dou8vec_minmax,
		.extra1		= SYSCTL_ZERO,
	...
	{
		.procname	= "tcp_ext_data_offset_nop128",
		.data		= &init_net.ipv4.sysctl_tcp_ext_data_offset_nop128,
		.maxlen		= sizeof(u8),
		.mode		= 0644,
		.proc_handler	= proc_dou8vec_minmax,
		.extra1		= SYSCTL_ZERO,
