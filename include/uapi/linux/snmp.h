...
enum
{
	...
	LINUX_MIB_TCPEDOSUCCESS,		/* TCPEDOSuccess */
	LINUX_MIB_TCPEDOFALLBACKSYN,		/* TCPEDOFallbackSYN */
	LINUX_MIB_TCPEDOFALLBACKSYNACK,		/* TCPEDOFallbackSYNACK */
	LINUX_MIB_TCPEDOFALLBACKACK,		/* TCPEDOFallbackACK */
	__LINUX_MIB_MAX
};
