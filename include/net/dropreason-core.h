...
enum skb_drop_reason {
	...
	/** @SKB_DROP_REASON_SOCKET_ACCEPT_QUEUE: accept queue is full */
	SKB_DROP_REASON_SOCKET_ACCEPT_QUEUE,
	/** @SKB_DROP_REASON_SOCKET_RCV_SHUTDOWN: recv queue is shutdown()ed */
	SKB_DROP_REASON_SOCKET_RCV_SHUTDOWN,
	/** @SKB_DROP_REASON_SOCKET_CLOSED: socket is close()d. */
	SKB_DROP_REASON_SOCKET_CLOSED,
	/** @SKB_DROP_REASON_SOCKET_PEER_CLOSED: peer socket is close()d. */
	SKB_DROP_REASON_SOCKET_PEER_CLOSED,
	/** @SKB_DROP_REASON_UNIX_TOO_MANY_FD: open too many fd */
	SKB_DROP_REASON_UNIX_TOO_MANY_FD,
	/**
	 * @SKB_DROP_REASON_UNIX_SKIP_OOB: OOB is passed through by recv()
	 * without MSG_OOB.
	 */
