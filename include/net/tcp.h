...
#define MAX_TCP_OPTION_SPACE_EDO (U16_MAX - sizeof(struct tcphdr))
...
#define TCPOPT_EDO_SUPPORTED	252	/* Extended Data Offset Supported */
#define TCPOPT_EDO_LENGTH	253	/* Extended Data Offset Length */
