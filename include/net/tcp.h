...
#define MAX_TCP_HEADER_SPACE (sizeof(struct tcphdr) + MAX_TCP_OPTION_SPACE)
...
#define TCPOPT_EXP_EDO		TCPOPT_EXP	/* Extended Data Offset */
...
#define TCPOLEN_EXP_EDO_EXT_ALIGNED	8
...
static inline void __tcp_fast_path_on(struct tcp_sock *tp, u32 snd_wnd)
{
	...
	/* EDO Extension option must be parsed and skb_pull()ed;
	 * otherwise TCP options in the extra space would be ACKed
	 * and recv()ed.
	 */
	if (tp->edo)
		return;
